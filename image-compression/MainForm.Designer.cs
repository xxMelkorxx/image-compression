namespace image_compression
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
	        ...
	        this.button_loadInitImage.Click += new System.EventHandler(this.OnClickButtonLoadImage);
	        // 
	        ...
	        this.button_compressAndSaveImage.Click += new System.EventHandler(this.OnClickButtonCompressAndSaveImage);
	        // 
